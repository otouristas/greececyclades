...
const TinosGuide: React.FC = () => {
  ...
  const tinos = islands.find(island => island.name === 'Tinos');
      ...
      <div className="relative h-screen overflow-hidden">
        ...
        >
          <div 
            ...
            style={{ 
              backgroundImage: `url(${tinos.image})`,
              transform: 'scale(1.1)'
            }}
          />
        ...
        <div className="relative h-full flex flex-col justify-center items-center text-white px-4">
          ...
          >
            ...
            <div className="flex gap-4 justify-center">
              {tinos.idealFor.map((ideal, index) => (
                <span 
                  key={index}
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <section className="mb-16">
          <div className="prose max-w-none">
            <p className="text-lg text-gray-700 leading-relaxed">
              Discover Tinos, an island of profound spiritual significance and artistic heritage in 
              the heart of the Cyclades. Known for its marble craftsmanship, picturesque villages, 
              and religious pilgrimage sites, Tinos offers a unique blend of cultural experiences 
              and natural beauty. From the iconic Church of Panagia Evangelistria to the traditional 
              dovecotes scattered across the landscape, from pristine beaches to authentic mountain 
              villages, this guide will help you explore an island that perfectly balances religious 
              tradition with authentic Greek island life.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <p>{tinos.weather.temp}, {tinos.weather.condition}</p>
            </div>
            <div className="bg-blue-50 p-6 rounded-lg">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {tinos.highlights.map((highlight, index) => (
        ...
        <section className="text-center">
          ...
          <p className="text-lg text-gray-700 mb-8">
            Start planning your perfect Tinos getaway today
          </p>
          <button
