...
const FolegandrosGuide: React.FC = () => {
  ...
  const seoData = {
    ...
    description: "Plan your perfect Folegandros vacation with our comprehensive 2025 travel guide. Discover the best hotels, restaurants, beaches, and activities. From dramatic cliffs to pristine beaches and traditional villages.",
    keywords: [
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="p-6">
                  ...
                  <ul className="space-y-4">
                    <li>
                      ...
                      <p className="text-gray-600">Handmade pasta served with rabbit, goat, or rooster in red sauce, a specialty of Folegandros.</p>
                    </li>
                    <li>
                      <span className="font-medium block">Souroto</span>
                      <p className="text-gray-600">A soft, white cheese with a slightly sour taste, similar to cottage cheese but with more character.</p>
                    </li>
                    <li>
                      <span className="font-medium block">Kalasouna</span>
                      <p className="text-gray-600">A savory cheese pie with wild greens, unique to Folegandros.</p>
                    </li>
                    <li>
                      <span className="font-medium block">Karavoli</span>
                      <p className="text-gray-600">Snails cooked with garlic, rosemary, and vinegar, a traditional delicacy.</p>
                    </li>
                    <li>
                      <span className="font-medium block">Melopita</span>
                      <p className="text-gray-600">A traditional honey pie made with local thyme honey and soft cheese.</p>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <section id="activities" className="mb-16">
            <h2 className="text-3xl font-bold mb-8">Things to Do in Folegandros</h2>
