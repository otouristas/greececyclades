...
const SifnosGuide: React.FC = () => {
  ...
  const sifnos = islands.find(island => island.name === 'Sifnos');
      ...
      <div className="relative h-screen overflow-hidden">
        ...
        >
          <div 
            ...
            style={{ 
              backgroundImage: `url(${sifnos.image})`,
              transform: 'scale(1.1)'
            }}
          />
        ...
        <div className="relative h-full flex flex-col justify-center items-center text-white px-4">
          ...
          >
            ...
            <div className="flex gap-4 justify-center">
              {sifnos.idealFor.map((ideal, index) => (
                <span 
                  key={index}
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <section className="mb-16">
          <div className="prose max-w-none">
            <p className="text-lg text-gray-700 leading-relaxed">
              Discover Sifnos, a culinary paradise in the heart of the Cyclades, where traditional 
              Greek gastronomy meets stunning landscapes and ancient pottery traditions. Known for 
              its exceptional local cuisine, picturesque villages, and ceramic craftsmanship, Sifnos 
              offers a perfect blend of cultural experiences and natural beauty. From the iconic 
              Chrysopigi Monastery to the medieval castle of Kastro, from pristine beaches to 
              traditional tavernas, this guide will help you explore an island that perfectly 
              balances culinary excellence with authentic Greek island life.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <p>{sifnos.weather.temp}, {sifnos.weather.condition}</p>
            </div>
            <div className="bg-blue-50 p-6 rounded-lg">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {sifnos.highlights.map((highlight, index) => (
        ...
        {/* Categories Grid */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-8">Explore Sifnos</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <section className="text-center">
          ...
          <p className="text-lg text-gray-700 mb-8">
            Start planning your perfect Sifnos getaway today
          </p>
          <button
