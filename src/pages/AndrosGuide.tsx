...
const AndrosGuide: React.FC = () => {
  ...
  const andros = islands.find(island => island.name === 'Andros');
      ...
      <div className="relative h-screen overflow-hidden">
        ...
        >
          <div 
            ...
            style={{ 
              backgroundImage: `url(${andros.image})`,
              transform: 'scale(1.1)'
            }}
          />
        ...
        <div className="relative h-full flex flex-col justify-center items-center text-white px-4">
          ...
          >
            ...
            <div className="flex gap-4 justify-center">
              {andros.idealFor.map((ideal, index) => (
                <span 
                  key={index}
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <section className="mb-16">
          <div className="prose max-w-none">
            <p className="text-lg text-gray-700 leading-relaxed">
              Experience Andros, the greenest island of the Cyclades, where lush valleys meet crystal-clear 
              waters and ancient paths lead to hidden waterfalls. Known for its rich maritime history, 
              stunning hiking trails, and pristine beaches, Andros offers a perfect blend of natural beauty 
              and cultural heritage. From the elegant capital of Chora with its neoclassical mansions to 
              the medieval Faneromeni Castle, from verdant hiking paths to golden sandy beaches, this guide 
              will help you discover an island that combines the best of Mediterranean landscapes with 
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <p>{andros.weather.temp}, {andros.weather.condition}</p>
            </div>
            <div className="bg-blue-50 p-6 rounded-lg">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {andros.highlights.map((highlight, index) => (
        ...
        {/* Categories Grid */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-8">Explore Andros</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <section className="text-center">
          ...
          <p className="text-lg text-gray-700 mb-8">
            Start planning your perfect Andros getaway today
          </p>
          <button
