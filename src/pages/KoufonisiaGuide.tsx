...
const KoufonisiaGuide: React.FC = () => {
  ...
  const koufonisia = islands.find(island => island.name === 'Koufonisia');
  ...
  return (
    <div className="min-h-screen bg-white" ref={containerRef}>
      <SEO {...generateGuideSEO('Koufonisia')} />
      ...
      <div className="relative h-screen overflow-hidden">
        ...
        >
          <div 
            ...
            style={{ 
              backgroundImage: `url(${koufonisia.image})`,
              transform: 'scale(1.1)'
            }}
          />
        ...
        <div className="relative h-full flex flex-col justify-center items-center text-white px-4">
          ...
          >
            ...
            <div className="flex gap-4 justify-center">
              {koufonisia.idealFor.map((ideal, index) => (
                <span 
                  key={index}
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <section className="mb-16">
          <div className="prose max-w-none">
            <p className="text-lg text-gray-700 leading-relaxed">
              ...
              and Kato Koufonisi, offers visitors an authentic Greek island experience with its traditional 
              fishing village atmosphere, stunning coastal paths, and secluded coves. From swimming in 
              turquoise waters to exploring sea caves, from enjoying fresh seafood to watching spectacular 
              sunsets, Koufonisia provides a perfect escape for those seeking natural beauty and tranquility 
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <p>{koufonisia.weather.temp}, {koufonisia.weather.condition}</p>
            </div>
            <div className="bg-blue-50 p-6 rounded-lg">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {koufonisia.highlights.map((highlight, index) => (
        ...
        {/* Categories Grid */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-8">Explore Koufonisia</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <section className="text-center">
          ...
          <p className="text-lg text-gray-700 mb-8">
            Start planning your perfect Koufonisia getaway today
          </p>
          <button
