...
const ParosGuide: React.FC = () => {
  ...
  const paros = islands.find(island => island.name === 'Paros');
      ...
      <div className="relative h-screen overflow-hidden">
        ...
        >
          <div 
            ...
            style={{ 
              backgroundImage: `url(${paros.image})`,
              transform: 'scale(1.1)'
            }}
          />
        ...
        <div className="relative h-full flex flex-col justify-center items-center text-white px-4">
          ...
          >
            ...
            <div className="flex gap-4 justify-center">
              {paros.idealFor.map((ideal, index) => (
                <span 
                  key={index}
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <section className="mb-16">
          <div className="prose max-w-none">
            <p className="text-lg text-gray-700 leading-relaxed">
              Discover Paros, a stunning Cycladic island that perfectly balances traditional Greek charm 
              with modern amenities. Known for its beautiful beaches, picturesque villages, and vibrant 
              nightlife, Paros offers something for every type of traveler. From the enchanting streets 
              of Naoussa and Parikia to the golden sands of Kolympethres and Santa Maria, this guide 
              will help you explore the island's rich history, thriving food scene, and world-class 
              windsurfing spots. Whether you're seeking adventure, relaxation, or cultural experiences, 
              Paros promises an unforgettable Greek island experience.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <p>{paros.weather.temp}, {paros.weather.condition}</p>
            </div>
            <div className="bg-blue-50 p-6 rounded-lg">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {paros.highlights.map((highlight, index) => (
        ...
        {/* Categories Grid */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-8">Explore Paros</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <section className="text-center">
          ...
          <p className="text-lg text-gray-700 mb-8">
            Start planning your perfect Paros getaway today
          </p>
          <button
