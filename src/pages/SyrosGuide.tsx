...
const SyrosGuide: React.FC = () => {
  ...
  const syros = islands.find(island => island.name === 'Syros');
      ...
      <div className="relative h-screen overflow-hidden">
        ...
        >
          <div 
            ...
            style={{ 
              backgroundImage: `url(${syros.image})`,
              transform: 'scale(1.1)'
            }}
          />
        ...
        <div className="relative h-full flex flex-col justify-center items-center text-white px-4">
          ...
          >
            ...
            <div className="flex gap-4 justify-center">
              {syros.idealFor.map((ideal, index) => (
                <span 
                  key={index}
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <section className="mb-16">
          <div className="prose max-w-none">
            <p className="text-lg text-gray-700 leading-relaxed">
              ...
              heritage. From the medieval settlement of Ano Syros to the impressive Apollo Theater, 
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <p>{syros.weather.temp}, {syros.weather.condition}</p>
            </div>
            <div className="bg-blue-50 p-6 rounded-lg">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {syros.highlights.map((highlight, index) => (
        ...
        {/* Categories Grid */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-8">Explore Syros</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <section className="text-center">
          ...
          <p className="text-lg text-gray-700 mb-8">
            Start planning your perfect Syros getaway today
          </p>
          <button
