...
const AntiparosGuide: React.FC = () => {
  ...
  const antiparos = islands.find(island => island.name === 'Antiparos');
  ...
  return (
    <div className="min-h-screen bg-white" ref={containerRef}>
      <SEO {...generateGuideSEO('Antiparos')} />
      ...
      <div className="relative h-screen overflow-hidden">
        ...
        >
          <div 
            ...
            style={{ 
              backgroundImage: `url(${antiparos.image})`,
              transform: 'scale(1.1)'
            }}
          />
        ...
        <div className="relative h-full flex flex-col justify-center items-center text-white px-4">
          ...
          >
            ...
            <div className="flex gap-4 justify-center">
              {antiparos.idealFor.map((ideal, index) => (
                <span 
                  key={index}
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <section className="mb-16">
          <div className="prose max-w-none">
            <p className="text-lg text-gray-700 leading-relaxed">
              Discover Antiparos, a charming small island in the heart of the Cyclades, just a stone's 
              throw from its larger neighbor, Paros. Famous for its stunning cave, beautiful beaches, 
              and relaxed atmosphere, Antiparos offers an authentic Greek island experience away from 
              the crowds. This guide will help you explore everything from the impressive stalactites 
              and stalagmites of Antiparos Cave to the picturesque Chora and pristine beaches. Whether 
              you're seeking tranquility, adventure, or a mix of both, Antiparos provides the perfect 
              setting for an unforgettable Greek island holiday.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <p>{antiparos.weather.temp}, {antiparos.weather.condition}</p>
            </div>
            <div className="bg-blue-50 p-6 rounded-lg">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {antiparos.highlights.map((highlight, index) => (
        ...
        {/* Categories Grid */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-8">Explore Antiparos</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <section className="text-center">
          ...
          <p className="text-lg text-gray-700 mb-8">
            Start planning your perfect Antiparos getaway today
          </p>
          <button
